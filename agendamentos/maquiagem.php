    ...
    <div class="site-section bg-light" id="contact-section">
        <div class="row">
          ...
          <br><br><h3 class="scissors text-center" style="margin-bottom: 0">Escolha o melhor horário para seu agendamento</h3><br><br>
              <form action="maquiagem.php" method="get">
        ...
        <div class="row">
          <div class="container">
              <form action="../engine/agendar.php" method="post">
                ...
                <input type="hidden" name="tipo" value="maquiagem">
                ...
                while($i <= 38) {
                  ...
                  if($agenda[$i] != date('H:i:s', strtotime('00:00:00')) && date("l", strtotime($data)) != "Monday" && date("l", strtotime($data)) != "Sunday" && date("l", strtotime($data)) != "Tuesday" && date("l", strtotime($data)) != "Wednesday" && date("l", strtotime($data)) != "Thursday" && date("Y-m-d", strtotime($data)) >= date('Y-m-d')){ ?>
               ...
               if(date("l", strtotime($data)) == "Monday") {
                ...
                echo "<h1><b>Só agendamos maquiagens para Sextas e Sábados!</b></h1>"; 

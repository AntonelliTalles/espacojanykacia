                    ...
                    <div class="row">
                      <div class="container">
                        <br><br><h3 class="scissors text-center" style="margin-bottom: 0">Escolha o melhor horário para seu agendamento</h3><br><br>
                            <form action="vestidos.php" method="get">
                    ...
                    <div class="row">
                      <div class="container">
                        <form action="engine.php" method="post">
                          ...
                          <input type="hidden" name="tipo" value="vestidos">
                          ...
                          <div class="col-md-6" class="form-group">
                              <label for="reserva">Horas reservadas para esse agendamento?</label>
                              <input type="number" class="form-control" name="reserva" placeholder="Campo não obrigatório">
                          </div>

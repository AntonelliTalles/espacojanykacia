...
if($tipo == 'noivas') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - '.$reserva.' hour"));
...
if($tipo == 'coloração') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 2 hour"));
...
if($tipo == 'corte') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 1 hour"));
...
if($tipo == 'madrinhas') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 1 hour 30 minute"));
...
if($tipo == 'maquiagem') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 45 minute"));
...
if($tipo == 'mecha') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 3 hour"));
...
if($tipo == 'penteado') {
    ...
    $rev = date("H:i:s", strtotime($horario . "  - 40 minute"));
